...
%configure --enable-shared-zlib --without-javac --disable-megaco-flex-scanner-lineno --disable-megaco-reentrant-flex-scanner  --disable-hipe --disable-dynamic-ssl-lib --with-ssl --prefix=%{erl_dest} 
